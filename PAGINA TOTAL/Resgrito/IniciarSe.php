...
$insertardatos = "INSERT INTO `iniciar seccion`(`Correo_Electronico`,`Contras`) VALUES ('$CorreoElectro','$Contraseña_1')";
...
<head>
  ...
  <link rel="stylesheet" href="IniciarSe.php">
</head>
<body>
...
<form action="Register.php" name="Iniciar_Seccion" method="POST"  >

    <div class="field">
    <input name = "Correo_electronico"  type="email" id="email" placeholder="tu@correo.com" autocomplete="email"/> 
    <label for="email">Correo electrónico</label>
     
    </div>

    <div class="field">
      <input name = "Contraseña" type="password" id="password" placeholder="••••••••" autocomplete="current-password"/>
  ...
  <button name="Boton_Listo" type="submit" class="btn-login">
    ...
    <p class="form-footer">
      ¿No tienes cuenta? <a href="http://127.0.0.1:5500/Resgrito/Iniciarseccion.html">Regístrate aquí</a>
    </p>
  </div>
